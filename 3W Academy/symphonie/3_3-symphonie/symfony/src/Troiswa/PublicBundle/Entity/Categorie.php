...
class Categorie
{
     ...
     * Add films
     *
     * @param \Troiswa\PublicBundle\Entity\Categorie $films
     * @return Categorie
     */
    public function addFilm(\Troiswa\PublicBundle\Entity\Categorie $films)
    {
        $this->films[] = $films;
     ...
     * @param \Troiswa\PublicBundle\Entity\Categorie $films
     */
    public function removeFilm(\Troiswa\PublicBundle\Entity\Categorie $films)
    {
